...
# Add more lanuage tokens for different languages.
langs = {"en_XX", "it_IT", "es_XX", "fr_FR", "de_DE", "pt_PT", "zh_CN"}
    ...
    def __init__(
        ...
        for g in graphs:
            ...
            if 'lng' in g.metadata:
                self.snt_lang.append(g.metadata['lng'] if g.metadata['lng'] in langs else 'en_XX')
            else:
