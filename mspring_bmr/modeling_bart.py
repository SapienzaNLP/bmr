...
class AMRBartForConditionalGeneration(BartForConditionalGeneration):
    def __init__(self, config: BartConfig):
        ...
        self.model.decoder.pointer_k = nn.Linear(self.config.d_model, self.config.d_model)
        self.model.decoder.pointer_q = nn.Linear(self.config.d_model, self.config.d_model)
